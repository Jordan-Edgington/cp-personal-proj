...
function MealMakerPage() {
    ...
    return (
      <div className='flex flex-col w-full h-full justify-center items-center text-center'>
        <div className='flex flex-col w-3/4 items-center justify-center text-center border-red-900 border-2 bg-white bg-opacity-50 rounded'>
        <p className='text-2xl font-bold mt-4'>The Meal Maker</p>
        ...
        <div className="p-8 bg-gradient-to-br from-white to-gray-200 rounded-lg shadow-md relative m-4">
          <form onSubmit={handleMealGen}>
            <div className='flex flex-row items-center'>
              ...
              <input type='number' className='border-2 border-gray-400 rounded m-2 px-2 py-1 focus:outline-none focus:border-red-700' onChange={(e)=>{setCalorieInput(e.target.value)}} />
              <button type='submit' className='bg-gradient-to-br from-red-900 to-red-600 border-2 border-black text-white rounded px-4 py-2 hover:bg-orange-700 focus:outline-none focus:bg-orange-700'>Generate a Meal</button>
            </div>
          </form>
        ...
        <p className='fixed bottom-0 right-0 p-4'>Meals generated by <a className='font-semibold hover:text-orange-800'href='https://platform.openai.com/docs/overview'>OpenAI</a>.</p>
        </div>
      </div>
    )
  }
